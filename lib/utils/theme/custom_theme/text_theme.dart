...
class TTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    bodySmall: const TextStyle().copyWith(fontSize: 14.6, fontWeight: FontWeight.w500, color: Colors.black.withOpacity(0.85)),

    labelLarge: const TextStyle().copyWith(fontSize: 12.0, fontWeight: FontWeight.normal, color: Colors.black),
    labelMedium: const TextStyle().copyWith(fontSize: 12.8, fontWeight: FontWeight.normal, color: Colors.black.withOpacity(0.65)),
  );
  static TextTheme dartTextTheme = TextTheme(
    ...
    bodySmall: const TextStyle().copyWith(fontSize: 14.6, fontWeight: FontWeight.w500, color: Colors.white.withOpacity(0.85)),
    
    labelLarge: const TextStyle().copyWith(fontSize: 12.0, fontWeight: FontWeight.normal, color: Colors.white),
    labelMedium: const TextStyle().copyWith(fontSize: 12.8, fontWeight: FontWeight.normal, color: Colors.white.withOpacity(0.65)),
  );
}